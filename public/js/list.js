...
const configData = async () => {
  var listConfig = await fetch("../../hc/tempData/objectConfig.json").then(response => { return response.json(); });
...
const tempData = async () => {
  var objVars = await fetch("../../hc/tempData/listOfObjects.json").then(response => { return response.json(); });
