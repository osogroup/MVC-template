  ...
  textareaHTML += '<div class="col-12">'
                + '<form action="#" method="post" class="demoForm">'
                  + '<fieldset class="minHeight">'
                    ...
                    + '<textarea class="textareaInput" id="input'+textarea.newHKey+'" placeholder="'+textarea.newHKey+'" oninput="anyChange(this.placeholder)" onchange="showData()" rows="2" cols="30">'+textarea.newHVal+'</textarea>'
     // + '<input type="textarea" class="col-12" id="input'+headerKey+'" value="'+headerValue+'" placeholder="'+headerKey+'" oninput="anyChange(this.placeholder)" onchange="showData()">'
                  + '</fieldset>'
                + '</form>'
              + '</div>';
  ...
  calendarHTML += '<div class="col-12">'
                  + '<form action="#" method="post" class="demoForm">'
                    + '<fieldset class="minHeight">'
                      ...
                      + '<input type="date" id="input'+date.newHKey+'" value="'+date.newHVal+'" oninput="anyChange(this.placeholder)" onchange="showData()" name="">'
                    + '</fieldset>'
                  + '</form>'
                + '</div>';
