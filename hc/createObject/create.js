...
function addLocal() {
  localStorage.setItem("name", "Riley Anders");
}
...
function doTheHTML() {
  ...
  var inputBox = '<input class="col-12" id="input" type="textarea" value="'+localStorage.getItem("name")+'" oninput="addLocal("'+localStorage.getItem("name")+'", this.value)">';
